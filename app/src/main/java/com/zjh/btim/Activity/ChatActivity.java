...
public class ChatActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case BLUE_TOOTH_READ_FILE:
                    Log.i("bluetooth file transfer", "file received(" + msg.obj + ")");
                ...
                case BLUE_TOOTH_WRAITE_FILE:
                    Log.i("bluetooth file transfer", "file sent");
                    dialog.dismiss();
    ...
    private void send() {
        String write = et_write.getText().toString().trim();
        if (TextUtils.isEmpty(write)) {
            Snackbar.make(et_write, "Send content cannot be empty", Snackbar.LENGTH_LONG).show();
            return;
        }
        ...
        XPermissionUtil.requestPermissions(this, 1,
                ...
                new XPermissionUtil.OnPermissionListener() {
                    ...
                    public void onPermissionDenied() {
                        //权限获取失败
                        Snackbar.make(et_write, "Please manually go to the setting interface to give relevant permissions", Snackbar.LENGTH_LONG).show();
                    }
                });
    }
        ...
        switch (requestCode) {
            case FILE_SELECT_CODE:
                if (resultCode == RESULT_OK) {
                    ...
                    Log.i("Select a document", "File Path: " + path);
                    if (path != null) {
                        ...
                        ad.setMessage("are you sure you want to send" + path + "?");
                        ad.setTitle("hint");
