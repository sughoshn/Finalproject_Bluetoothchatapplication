...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Bluetooth Chat Application");
        initView();
    }
        ...
        XPermissionUtil.requestPermissions(this, 1,
                ...
                new XPermissionUtil.OnPermissionListener() {
                    ...
                    public void onPermissionDenied() {
                        ...
                        Snackbar.make(bottomNavigationView, "Please manually go to the setting interface to give relevant permissions", Snackbar.LENGTH_LONG).show();
                    }
                });
    }
